...
class CategoryFilter
{
     ...
     * @return string[]
     */
    public function getExcludedCategoriesFromRequest(Request $request, string $paramName = 'exclude', string $default = 'Skins,Glyphs,Resources,Misc,Node,Sigils,Enemy,Arch-Gun,Fish'): array
    {
